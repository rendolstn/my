                    ...
                    <div class="card-body">
                      <?php
                        ...
                        if(isset($_GET['postID'])){
                          $catID = $_GET['postID'];
                          $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_page` WHERE cuid = '$catID'") or die(mysqli_error());
                  ...
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_page` ORDER BY cuid ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/page/?postID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-edit"></i>
                              </a>
                              <a href="<?php echo $urlweb; ?>/function/del-page.php?cuid=<?php echo $s1['cuid']; ?>&jenis=1" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">
