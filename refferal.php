          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Information /</span> <span class="text-muted fw-light">Member /</span> Refferal
                      ...
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        <thead>
                          <tr class="bg-info">
                            ...
                            <th class="text-center" style="vertical-align: middle;">Total Downline</th>
                            <th class="text-center" style="vertical-align: middle;">Total Commission</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            ...
                            while($s1 = mysqli_fetch_array($sql_1)){
                              $no++;
                              $usernya = $s1['cuid'];
                              $sql_3 = mysqli_query($conn,"SELECT SUM(total) as komisi FROM `tb_transaksi` WHERE userID = '$usernya' AND jenis = 4") or die(mysqli_error());
                          ...
                          <tr>
                            ...
                            <td class="text-left" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['full_name']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['reff']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo number_format($s3['komisi']); ?></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
