          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Information /</span> <span class="text-muted fw-light">Member /</span> Basic Member
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/function/reseller.php?postID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure want to Upgrade this user be a Reseller?');">
                                Upgrade
                              </a>
                              <a href="<?php echo $urlweb; ?>/function/user-status.php?postID=<?php echo $s1['cuid']; ?>&status=<?php echo $s1['status']; ?>&tipe=1" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a>
                              <a href="<?php echo $urlweb; ?>/function/del-user.php?cuid=<?php echo $s1['cuid']; ?>&tipe=1" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');">
