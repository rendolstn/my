        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaction /</span> Order Joki List</h4>
              <div class="row">
                <?php
                  error_reporting(0);
                  $today = date('Y-m');
                  ...
                  $sql_7 = mysqli_query($conn,"SELECT * FROM `tb_order` WHERE providerID = 11 AND status = 3 AND created_date LIKE '$today%'") or die(mysqli_error());
              ...
              <div class="card">
                <div class="card-datatable table-responsive">
                  <table id="default-datatable" class="invoice-list-table table border-top">
                    ...
                    <tbody>
                      <?php
                        $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_order` WHERE providerID = 11 ORDER BY created_date DESC") or die(mysqli_error());
                        $no=0;
                      ...
                      <tr>
                        ...
                        <td class="text-right" style="vertical-align: middle; white-space: normal; font-size: 12px; text-align: right!important;"><?php echo number_format($s1['sub_total']); ?></td>
                        <td class="text-left" style="vertical-align: middle; white-space: normal; font-size: 12px; text-align: center!important;">
                          <?php
                            if($status == 0){
                              echo '
                        ...
                        <td class="text-center" style="vertical-align: middle; white-space: nowrap; font-size: 12px;">
                          <?php
                              if($status == 1){
                          ?>
                          <a href="#myModal<?php echo $s1['cuid']; ?>a" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $s1['cuid']; ?>a" data-bs-backdrop="static" data-bs-keyboard="false">Proses</a>
                            <div class="modal fade" id="myModal<?php echo $s1['cuid']; ?>a" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="table-responsive">
                                      <table class="table table-bordered text-left">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td class="text-left" style="text-align: left!important;">Detail</td>
                                            <td class="text-left" style="text-align: left!important;">
                                              <strong>Email :</strong> <?php echo $s1['userID']; ?><br>
                                              <strong>Password :</strong> <?php echo $s1['zoneID']; ?><br>
                                              <strong>Nickname :</strong> <?php echo $s1['nickname']; ?><br>
                                              <strong>Request Hero :</strong> <?php echo $s1['trxID']; ?><br>
                                              <strong>Login Via :</strong> <?php echo $s1['services']; ?><br>
                                              <strong>Qty :</strong> <?php echo $s1['qty']; ?><br>
                                              <strong>Catatan :</strong> <?php echo $s1['note']; ?><br>
                                            </td>
                                          </tr>
                                          <tr>
                                  ...
                                  <?php if($status == 1){ ?>
                                  <form action="<?php echo $urlweb; ?>/function/proses_joki.php" method="POST">
                                    <div class="modal-body" style="white-space: normal;">
                                      <p style="white-space: normal;">Silahkan Tuliskan keterangan melalui form dibawah ini :</p>
                                      <input class="form-control mb-3" type="hidden" name="postID" value="<?php echo $s1['cuid']; ?>">
                                      <textarea class="form-control mb-3" name="catatan" placeholder="Write something..."></textarea>
                                    </div>
                          ...
                          <?php } ?>
                          <a href="<?php echo $urlweb; ?>/function/del-orderjoki.php?cuid=<?php echo $s1['kd_transaksi']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
