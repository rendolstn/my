          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">System /</span> <span class="text-muted fw-light">Settings /</span> Reseller Area
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="alert alert-info d-flex align-items-center mb-3" role="alert">
                        ...
                        <span class="text-dark">Halaman ini berfungsi untuk mengaktifkan fitur upgrade Basic Member menjadi Reseller Member dengan syarat minimal Transaksi</span>
                      </div>
                      <?php
                        error_reporting(0);
                        if (!empty($_GET['notif'])) {
                          if ($_GET['notif'] == 1) {
                            echo '
                              <div class="alert alert-success d-flex align-items-center" role="alert">
                                ...
                                <span><strong>Well Done!</strong> Reseller Area Saved!</span>
                              </div>
                            ';
                          }
                        }
                      ?>
                      <form role="form" action="<?php echo $urlweb; ?>/function/upgrade.php" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                          <label class="form-label">Upgrade Reseller</label>
                          <select name="upgrade" class="form-control">
                            <option> Pilih Status </option>
                            <option value="0"<?php if($s0['upgrade'] == 0) { echo ' selected=selected'; } ?>> Tidak Aktif </option>
                            <option value="1"<?php if($s0['upgrade'] != 0) { echo ' selected=selected'; } ?>> Aktif </option>
                          </select>
                        </div>
                        <div class="form-group mb-2">
                          <label class="form-label">Minimal Transaction</label>
                          <input type="number" class="form-control" name="qty" value="<?php echo $s0['upgrade']; ?>">
                        </div>
                        <button type="submit" name="submit" class="btn btn-primary">Publish</button>
                        <a href="<?php echo $urlweb; ?>/upgrade/" class="btn btn-light">Cancel</a>
                      </form>
                    </div>
                  </div>
                </div>
