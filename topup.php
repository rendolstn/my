              ...
              <div class="card">
                <div class="card-datatable table-responsive">
                  <table id="default-datatable" class="invoice-list-table table border-top">
                    ...
                    <tbody>
                      <?php
                        $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_transaksi` WHERE providerID = 0 AND note != 'Pengurangan Saldo' ORDER BY  cuid DESC") or die(mysqli_error());
                        $no=0;
                        while($s1 = mysqli_fetch_array($sql_1)){
                          ...
                          $sql_3 = mysqli_query($conn,"SELECT * FROM `tb_tripay` WHERE merchant_ref = '$trxID'") or die(mysqli_error());
                      ...
                      <tr>
                        ...
                        <td class="text-left" style="vertical-align: middle; white-space: nowrap; font-size: 14px;">
                            <?php echo $s2['user']; ?><br>
                            <small><?php echo $s2['no_hp']; ?></small>
                        </td>
                        <td class="text-right" style="vertical-align: middle; white-space: nowrap; font-size: 14px;"><?php echo number_format($s1['total']); ?></td>
                        <td class="text-center" style="vertical-align: middle; white-space: nowrap; font-size: 14px;"><?php echo $s1['metode']; ?><br><?php echo $s3['payment_name']; ?></td>
                        <td class="text-center" style="vertical-align: middle; white-space: nowrap; font-size: 14px;"><?php echo $s1['date']; ?></td>
                        <td class="text-center" style="vertical-align: middle; white-space: nowrap; font-size: 14px;">
                          <?php
                            if($s1['status'] == 0){
                              ...
                              echo '
                                <span class="badge-dot">
                                  <i class="bg-danger"></i> DIBATALKAN
                                </span>
                              ';
                            }
                          ?>
                        ...
                        <td class="text-center" style="vertical-align: middle; white-space: nowrap; font-size: 14px;">
                          <?php if($s1['status'] == 0){ ?>
                          <a href="<?php echo $urlweb; ?>/function/proses_topup.php?cuid=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure want proccess this data?');">Proses</a>
                          <?php } else { ?>
