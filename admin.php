                    ...
                    <div class="card-body">
                      <?php
                        if(isset($_GET['postID'])){
                          ...
                          $postID = $_GET['postID'];
                          $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_admin` WHERE cuid = '$postID'") or die(mysqli_error());
                          $s2 = mysqli_fetch_array($sql_2);
                          $cuid = $s2['cuid'];
                          $sql_jenis = mysqli_query($conn,"SELECT * FROM `tb_jenis` WHERE cuid = '$cuid'") or die(mysqli_error());
                      ...
                      <form role="form" action="<?php echo $urlweb; ?>/function/add-admin.php" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                          ...
                          <input class="form-control" type="text" value="<?php echo $sj['jenis']; ?>" readonly>
                          <input class="form-control" type="hidden" name="product_type" value="<?php echo $s2['cuid']; ?>">
                        </div>
                        <div class="form-group mb-2">
                          <label>Satuan :</label>
                        ...
                        <div class="form-group mb-2">
                          <label>Commission Affiliate :</label>
                          <input class="form-control" type="text" name="com_ref" value="<?php echo $s2['com_ref']; ?>">
                        ...
                        <table id="default-datatable" class="invoice-list-table table border-top">
                          <thead>
                            <tr class="bg-info">
                              ...
                              <th class="text-center">Markup Reseller</th>
                          ...
                          <tbody>
                            <?php
                              $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_admin` ORDER BY cuid ASC") or die(mysqli_error());
                              $no=0;
                            ...
                            <tr>
                              ...
                              <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['persen_sell']; ?></td>
                              <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['persen_res']; ?></td>
                              <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['com_ref']; ?></td>
                              <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php if($s1['satuan'] == 0) { echo 'Persen'; } else { echo 'Rupiah'; } ?></td>
                              <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                                <a href="<?php echo $urlweb; ?>/admin/?postID=<?php echo $s1['cuid']; ?>" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>
                              </td>
                            </tr>
                            <?php } ?>
                          </tbody>
