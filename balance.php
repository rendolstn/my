        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="<?php if($u['cuid'] == 1 || $u['cuid'] == 12){ echo 'col-sm-4'; } else { echo 'd-none'; } ?>">
                  <div class="card">
                    <div class="card-body">
                      <?php
                        error_reporting(0);
                          ...
                          if ($_GET['notif'] == 2) {
                            echo '
                              <div class="alert alert-success d-flex align-items-center" role="alert">
                                ...
                                <span><strong>Well Done!</strong> Balance Updated!</span>
                              </div>
                            ';
                          }
                        }
                        if(isset($_GET['postID'])){
                            $postID = $_GET['postID'];
                            $getBalance = mysqli_query($conn,"SELECT * FROM `tb_balance` WHERE userID = '$postID'") or die(mysqli_error());
                            $gb = mysqli_fetch_array($getBalance);
                      ?>
                      <form role="form" action="<?php echo $urlweb; ?>/function/edit-balance.php" method="post">
                        <div class="form-group mb-2">
                          <label class="form-label">User :</label>
                          <select name="userID" class="form-control select2" required>
                            <?php
                              $sql_11 = mysqli_query($conn,"SELECT * FROM `tb_user` WHERE cuid = '$postID'") or die(mysqli_error());
                              while($s11 = mysqli_fetch_array($sql_11)){
                            ?>
                            <option value="<?php echo $s11['cuid']; ?>"> <?php echo $s11['user']; ?> ( <?php echo $s11['full_name']; ?> ) </option>
                            <?php } ?>
                          </select>
                        </div>
                        <div class="form-group mb-2">
                          <label class="form-label">Saldo Aktif</label>
                          <input type="number" name="saldo_aktif" min="0" max="999999999" step="1" value="<?php echo $gb['active']; ?>" class="form-control" required>
                        </div>
                        <div class="form-group mb-2">
                          <label class="form-label">Saldo Pending</label>
                          <input type="number" name="saldo_pending" min="0" max="999999999" step="1" value="<?php echo $gb['pending']; ?>" class="form-control" required>
                        </div>
                        <div class="form-group mb-2">
                          <label class="form-label">Saldo Payout</label>
                          <input type="number" name="saldo_payout" min="0" max="999999999" step="1" value="<?php echo $gb['payout']; ?>" class="form-control" required>
                        </div>
                      ...
                      <form role="form" action="<?php echo $urlweb; ?>/function/topup.php" method="post">
                        ...
                        <div class="form-group mb-2">
                          ...
                          <input type="number" name="nominal" min="10000" max="999999999" step="1000" value="10000" class="form-control" required>
                        </div>
                        <div class="form-group mb-2">
                ...
                <div class="<?php if($u['cuid'] == 1 || $u['cuid'] == 12){ echo 'col-sm-8'; } else { echo 'col-sm-12'; } ?>">
                  <!-- Invoice List Table -->
                  <div class="card">
                      ...
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-right" style="vertical-align: middle; white-space: normal; text-align: right;"><?php echo number_format($sbl['active']); ?></td>
                            <td class="text-right" style="vertical-align: middle; white-space: normal; text-align: right;"><?php echo number_format($sbl['pending']); ?></td>
                            <td class="text-right" style="vertical-align: middle; white-space: normal; text-align: right;"><?php echo number_format($sbl['payout']); ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal;">
                                <a href="<?php echo $urlweb; ?>/balance/?postID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
