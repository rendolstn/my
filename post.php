                ...
                <div class="col-sm-7">
                  <div class="card">
                    <div class="card-body">
                      ...
                      ?>
                      <form role="form" action="<?php echo $urlweb; ?>/function/add-post.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                          ...
                          <textarea class="form-control summernoteEditor" type="text" name="content"><?php if(isset($_GET['postID'])) { echo $s2['content']; } ?></textarea>
                        </div>
                        <button type="submit" name="submit" class="btn btn-primary">Publish</button>
                        <a href="<?php echo $urlweb; ?>/post/" class="btn btn-light">Cancel</a>
                      </form>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_post` WHERE kategori = 0 ORDER BY cuid ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/post/?postID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-edit"></i>
                              </a>
                              <a href="<?php echo $urlweb; ?>/function/del-post.php?cuid=<?php echo $s1['cuid']; ?>&jenis=0" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">
