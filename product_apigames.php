                    ...
                    <div class="tab-pane fade show active" id="game" role="tabpanel">
                      <div class="card-datatable table-responsive">
                        <table id="default-datatable" class="invoice-list-table table border-top">
                          ...
                          <tbody>
                            <?php
                              $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_produk` WHERE jenis = 9 AND product_type = 1 ORDER BY cuid ASC") or die(mysqli_error());
                              $no=0;
                            ...
                            <tr>
                              ...
                              <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px; width: 10%;">
                                <a href="<?php echo $urlweb; ?>/product_apigames/?do=add&catID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                <a href="<?php echo $urlweb; ?>/function/del-produkgames.php?cuid=<?php echo $s1['cuid']; ?>&abc=<?php echo $s1['product_type']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                            <?php } ?>
                          </tbody>
                    ...
                    <div class="tab-pane fade" id="premium" role="tabpanel">
                      <div class="card-datatable table-responsive">
                        <table id="default-datatable1" class="invoice-list-table table border-top">
                          ...
                          <tbody>
                            <?php
                              $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_produk` WHERE jenis = 9 AND product_type = 2 ORDER BY cuid ASC") or die(mysqli_error());
                              $no=0;
                              while($s1 = mysqli_fetch_array($sql_1)){
                                $no++;
                                $jenis = $s1['jenis'];
