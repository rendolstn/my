                  ...
                  <div class="card">
                    <div class="card-body">
                      <?php
                        ...
                        if(isset($_GET['catID'])){
                          $catID = $_GET['catID'];
                          $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_kategori` WHERE cuid = '$catID'") or die(mysqli_error());
                      ...
                      <form role="form" action="<?php echo $urlweb; ?>/function/add-category.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                          <label class="form-label">Upload Icon Currency :</label>
                          <input type="file" name="subimage" class="form-control">
                          <span>PNG, 50px x 50px</span><br>
                          <?php if(isset($_GET['catID'])) { ?>
                          <img src="<?php echo $urlwebs; ?>/upload/<?php echo $s2['subimage']; ?>" class="img-fluid">
                          <?php } ?>
                        </div>
                        <div class="form-group mb-2">
                          ...
                          <select name="parent" class="form-control" required>
                            ...
                            <?php
                              $sql_jenis = mysqli_query($conn,"SELECT * FROM `tb_jenis` ORDER BY cuid ASC") or die(mysqli_error());
                              while($sj = mysqli_fetch_array($sql_jenis)){
                            ?>
                            <option value="<?php echo $sj['cuid']; ?>"<?php if(isset($_GET['catID'])) { if($s2['parent'] == $sj['cuid']) { echo 'selected = selected'; }} ?>> <?php echo $sj['jenis']; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                        <div class="form-group mb-2">
                  ...
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_kategori` ORDER BY cuid ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/function/kategori-populer.php?postID=<?php echo $s1['cuid']; ?>&populer=<?php echo $s1['populer']; ?>" class="btn <?php if($s1['populer'] == 0){ echo 'btn-success'; } else { echo 'btn-warning'; } ?> btn-sm"><i class="fa fa-star"></i></a>
                              <a href="<?php echo $urlweb; ?>/function/kategori-status.php?postID=<?php echo $s1['cuid']; ?>&status=<?php echo $s1['status']; ?>" class="btn <?php if($s1['status'] == 0){ echo 'btn-success'; } else { echo 'btn-warning'; } ?> btn-sm"><i class="fa fa-heart"></i></a>
                              <a href="<?php echo $urlweb; ?>/category/?catID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                              <a href="<?php echo $urlweb; ?>/function/del-category.php?cuid=<?php echo $s1['cuid']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');"><i class="fa fa-trash"></i></a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
