            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <?php
                ...
                if(isset($_GET['do'])){
                  ...
                  if(isset($_GET['catID'])){
                    $id = $_GET['catID'];
                    $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_produk_social` WHERE cuid = '$id'") or die(mysqli_error());
              ...
              <div class="card">
                <div class="card-datatable table-responsive">
                  <table id="default-datatable" class="invoice-list-table table border-top">
                    ...
                    <tbody>
                      <?php
                        $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_produk_social` WHERE jenis NOT IN(9,10) ORDER BY cuid ASC") or die(mysqli_error());
                        $no=0;
                      ...
                      <tr>
                        ...
                        <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px; width: 10%;">
                          <a href="<?php echo $urlweb; ?>/social_media/?do=add&catID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
