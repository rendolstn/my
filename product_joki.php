          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Product /</span> Product Joki ML
                <span class="float-right" style="float: right;">
                  <a href="<?php echo $urlweb; ?>/product_joki/?do=add" class="btn btn-primary" style="margin-top: -5px;"><i class="fa fa-plus"></i>&nbsp; Add Product</a>
                </span>
              </h4>
              <?php
                error_reporting(0);
                    ...
                    if ($_GET['notif'] == 1) {
                      echo '
                        <div class="alert alert-success d-flex align-items-center" role="alert">
                          ...
                          <span><strong>Well Done!</strong> Product Joki ML Saved!</span>
                        </div>
                      ';
                    }
                  }
              ...
              <div class="card">
                <div class="card-body">
                  <form role="form" class="form-group" action="<?php echo $urlweb; ?>/function/add-produkjoki.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                      ...
                      <select name="kategori" class="form-control" required>
                        ...
                        <?php
                          $sql_3 = mysqli_query($conn,"SELECT * FROM `tb_kategori` WHERE parent = 6 ORDER BY kategori ASC") or die(mysqli_error());
                    ...
                    <a href="<?php echo $urlweb; ?>/product_joki/" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
              <?php } else { ?>
                ...
                <div class="card-body">
                  <div class="card-datatable table-responsive">
                    <table id="default-datatable" class="invoice-list-table table border-top">
                      ...
                      <tbody>
                        <?php
                          $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_produk` WHERE jenis = 11 AND product_type = 1 ORDER BY cuid ASC") or die(mysqli_error());
                          $no=0;
                        ...
                        <tr>
                          ...
                          <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px; width: 10%;">
                            <a href="<?php echo $urlweb; ?>/product_joki/?do=add&catID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                            <a href="<?php echo $urlweb; ?>/function/del-produkjoki.php?cuid=<?php echo $s1['cuid']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
