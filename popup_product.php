                  ...
                  <div class="card">
                    <div class="card-body">
                      <?php
                        ...
                        if(isset($_GET['catID'])){
                          $catID = $_GET['catID'];
                          $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_banners` WHERE cuid = '$catID'") or die(mysqli_error());
                      ...
                      <form role="form" action="<?php echo $urlweb; ?>/function/banners.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                          ...
                          <select name="catID" class="form-control">
                            ...
                            ?>
                            <option value="<?php echo $sk['cuid']; ?>"<?php if(isset($_GET['catID'])) { if($s2['catID'] == $sk['cuid']) { echo 'selected = selected'; }} ?>> <?php echo $sk['kategori']; ?> </option>
                            <?php } ?>
                          </select>
                        </div>
                        <div class="form-group mb-2">
                  ...
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT a.*, a.cuid as banID,b.* FROM tb_banners as a INNER JOIN tb_kategori as b ON a.catID = b.cuid ORDER BY b.cuid ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/function/banners-status.php?postID=<?php echo $s1['cuid']; ?>&status=<?php echo $s1['status']; ?>" class="btn <?php if($s1['status'] == 'true'){ echo 'btn-success'; } else { echo 'btn-warning'; } ?> btn-sm"><i class="fa fa-heart"></i></a>
                              <a href="<?php echo $urlweb; ?>/popup_product/?catID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                              <a href="<?php echo $urlweb; ?>/function/del-popproduct.php?cuid=<?php echo $s1['banID']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');"><i class="fa fa-trash"></i></a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
