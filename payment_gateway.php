                      ...
                      <form role="form" action="<?php echo $urlweb; ?>/function/add-tripay.php" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                          ...
                          <select class="form-control" type="text" name="provider" required>
                            ...
                            <option value="1"<?php if(isset($_GET['postID'])){ if($s2['cuid'] == 1){ echo ' selected=selected'; }} ?>> Tripay </option>
                            <option value="3"<?php if(isset($_GET['postID'])){ if($s2['cuid'] == 3){ echo ' selected=selected'; }} ?>> Duitku </option>
                          </select>
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <hr>
                        <ol>
                            <li>Pada URL Callback isi dengan : https://namadomain.com/tripay_response.php (Untuk Tripay)</li>
                            <li>Pada URL Callback isi dengan : https://namadomain.com/duitku_response.php (Untuk Duitku)</li>
                          </ol>
                      </form>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_tripayapi` WHERE jenis = 0 AND status = 1 ORDER BY cuid ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/payment_gateway/?postID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                              <a href="<?php echo $urlweb; ?>/function/del-gateway.php?postID=<?php echo $s1['cuid']; ?>&status=<?php echo $s1['status']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');"><i class="fa fa-trash"></i></a>
                            </td>
                          </tr>
                          <?php } ?> 
                        </tbody>
