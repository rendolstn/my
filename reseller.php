          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Information /</span> <span class="text-muted fw-light">Member /</span> Reseller Member
                        ...
                        <tbody>
                          <?php
                            ...
                            while($s1 = mysqli_fetch_array($sql_1)){
                              ...
                              $sql_3 = mysqli_query($conn,"SELECT * FROM `tb_user` WHERE cuid = '$uplineID'") or die(mysqli_error());
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s3['user']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/function/downres.php?postID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure want to Downgrade this user from a Reseller?');">
                                Downgrade
                              </a>
                              <a href="<?php echo $urlweb; ?>/function/user-status.php?postID=<?php echo $s1['cuid']; ?>&status=<?php echo $s1['status']; ?>&tipe=3" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a>
                              <a href="<?php echo $urlweb; ?>/function/del-user.php?cuid=<?php echo $s1['cuid']; ?>&tipe=3" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');">
