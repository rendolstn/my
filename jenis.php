              ...
              <div class="row">
                <?php
                  if(isset($_GET['postID'])){
                    $postID = $_GET['postID'];
                    $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_jenis` WHERE cuid = '$postID'") or die(mysqli_error());
                          ...
                          if ($_GET['notif'] == 1) {
                            echo '
                              <div class="alert alert-success d-flex align-items-center" role="alert">
                                ...
                                <span><strong>Well Done!</strong> Product Tab Saved!</span>
                              </div>
                            ';
                          }
                        }
                      ?>
                      <form role="form" action="<?php echo $urlweb; ?>/function/edit-jenis.php" method="post">
                        <div class="form-group mb-2">
                          <label class="form-label">Title :</label>
                          <input class="form-control" type="text" value="<?php echo $s2['jenis']; ?>" readonly>
                        </div>
                        <div class="form-group mb-2">
                          <label class="form-label">Icon Font Awesome :</label>
                          <input class="form-control" type="text" name="image" value="<?php echo $s2['image']; ?>" required>
                          <input class="form-control" type="hidden" name="postID" value="<?php echo $s2['cuid']; ?>">
                        </div>
                        <div class="form-group mb-2">
                          <label class="form-label">Sort Order :</label>
                          <input class="form-control" type="text" name="sort" value="<?php echo $s2['sort']; ?>">
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <a href="<?php echo $urlweb; ?>/jenis/" class="btn btn-light">Cancel</a>
                      </form>
                    </div>
                  </div>
                </div>
                <?php } ?>
                <div class="<?php if(isset($_GET['postID'])){ echo 'col-sm-9'; } else { echo 'col-sm-12'; } ?>">
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_jenis` ORDER BY cuid ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/jenis/?postID=<?php echo $s1['cuid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
